...
const newsItems = [
  {
    id: 1,
    title: "Οργή στην Ξάνθη για τις φόλες – Επικήρυξαν με 2.000 ευρώ αυτόν που σκότωσε τον “Νταλάρα”",
    date: "2025-05-01",
    content: "Από οργή ξεχειλίζουν οι φιλόζωοι στην Ξάνθη μετά και τα τελευταία – πολλαπλά – περιστατικά θανάτωσης σκύλων με φόλες. Το πιο πρόσφατο μάλιστα περιστατικό, αυτό της δηλητηρίασης ενός σκύλου ιδιαίτερα φιλήσυχου επί της οδού Μιαούλη, αποτέλεσε την σταγόνα για να ξεχειλίσει το ποτήρι. Όπως αναφέρει η φιλοζωική οργάνωση Αδέσποτοι Φίλοι Ξάνθης, ο εν λόγω σκύλος λεγόταν “Νταλάρας” και τον φρόντιζαν οι κάτοικοι της περιοχής, που κάνουν λόγο για ένα ήσυχο και άκακο ζώο. Μάλιστα, δίνεται αμοιβή 2.000 ευρώ σε όποιον δώσει πληροφορίες για τον δράστη που έριξε τις φόλες.",
    image: "https://www.xanthinea.gr/wp-content/uploads/2025/05/ntalaras-1-696x364.jpg",
  },
{
    id: 2,
    title: "Αδεσποτούλια Ξάνθης: Ένα καμένο φορτηγάκι που ήταν οικογένεια",
    date: "2025-05-03",
    content: "Στην Ξάνθη συναντήσαμε την κυρία Άννα Μαρία Ζαφειριάδου, μέλος της φιλοζωικής ομάδας «Αδεσποτούλια Ξάνθης», λίγες ημέρες μετά την κλοπή και την ολοσχερή καταστροφή από φωτιά στο «σαραβαλάκι της», όπως το αποκαλεί. Ένα όχημα που, επί 13 χρόνια και με 442.000 χιλιόμετρα στο κοντέρ του, είχε μεταφέρει εκατοντάδες ζώα σε γιατρούς, σε οικογένειες και στην ασφάλεια. Ήταν ένας σιωπηλός ήρωας.",
    image: "https://media.oneman.gr/onm-images/01-586.jpg?_gl=1*1ocgvul*_ga*NjU4NTcxODYwLjE3NDY4NzMyMTE.*_ga_Y6ZBNQK05H*czE3NDY4NzMyMTEkbzEkZzEkdDE3NDY4NzMyODMkajYwJGwwJGgxOTUyMzkzMTA5",
  },
  {
    id: 3,
